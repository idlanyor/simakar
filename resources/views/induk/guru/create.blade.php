                ...
                <form action="{{ route('guru.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ old('nik') }}" name="nik" class="form-control" id="input3">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="id_gtk" class=" form-control custom-select select2">
                                    @foreach ($jenis as $item)
                                            <option value="{{ $item->id }}">{{ $item->jenis_gtk }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="alamat" value="{{ old('alamat') }}" id="input5" cols="96"
                                    rows="5"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('lama_kerja') }}" name="lama_kerja" class="form-control"
                                    id="lamakerja">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('sk_pengangkatan') }}" name="sk_pengangkatan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{ old('tmt_pengangkatan') }}" name="tmt_pengangkatan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('ijazah_terakhir') }}" name="ijazah_terakhir"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('email') }}" name="email" class="form-control" id="cono2">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="cono3" class="col-sm-3  control-label col-form-label">Nomor Telepon/Whatsapp</label>
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('no_hp') }}" name="no_hp" class="form-control" id="cono3">
                            </div>
                        </div>
                    </div>
