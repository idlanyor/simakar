            ...
            <div class="col-md-6 col-lg-3">
                <div class="card card-hover">
                    <div class="box bg-cyan">
                        <h1 class="font-light text-white text-center"><i class="fas fa-users"></i></h1>
                        <span class="text-white ">Jumlah Siswa</span>
                        <span class="text-white float-right">215 Siswa</span>
                    </div>
                </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3">
                <div class="card card-hover">
                    <div class="box bg-success">
                        <h1 class="font-light text-white text-center"><i class="fas fa-user-secret"></i></h1>
                        <span class="text-white ">Jumlah GTK</span>
                        <span class="text-white float-right">24 GTK</span>
                    </div>
                </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3">
                <div class="card card-hover">
                    <div class="box bg-warning">
                        <h1 class="font-light text-white text-center"><i class="fas fa-th"></i></h1>
                        <span class="text-white ">Rombel Aktif</span>
                        <span class="text-white float-right">6 Rombel</span>
                    </div>
                </div>
            </div>
            <!-- Column -->
